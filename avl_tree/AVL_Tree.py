...
class AVLTree(object):
    ...
    def leftRotate(self, rotate):
        temp = rotate.r
        temp2 = temp.l
        temp.l = rotate
        rotate.r = temp2
        rotate.h = 1 + max(self.getHeight(rotate.l),
                           self.getHeight(rotate.r))
        temp.h = 1 + max(self.getHeight(temp.l),
                           self.getHeight(temp.r))
        return temp

    # função de rotação para direita
    def rightRotate(self, rotate):
        temp = rotate.l
        temp3 = temp.r
        temp.r = rotate
        rotate.l = temp3
